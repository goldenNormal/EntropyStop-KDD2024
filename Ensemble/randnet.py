...
from Ensemble.networks.masked_AE import MaskLinearAE
from Ensemble.utils.data_loader import CustomizeDataLoader
import time
...
class LinearRandNet():
    ...
    def predict(self,test_data):
        ...
        data = torch.FloatTensor(test_data).to('cuda')
        predictions = []
        with torch.no_grad():
            ...
            od_score = np.median(reconstruction_loss, axis=1)
