...
from DeepODModel.NTL_LOE.models import MyTrainer
from DeepODModel.NTL_LOE.models.Losses import DCL
...
def run_one(path,file_name):
    ...
    network = TabNets
    trainer_class = MyTrainer.My_trainer
